  ...
  <div class="container ">
    <nav class="navbar navbar-light bg-success object-fit-cover border rounded mt-3">
      <div class="container-fluid">
        <a class="navbar-brand"><img src="image/Logo.jpg " width="80" class="rounded float-start" alt=""></a>
        <h4>KURSUS MENJAHIT SERUNI SWEET</h4>
      </div>
    </nav>
    <div class="container">
      ...
      <br>
      <h4>KURSUS MENJAHIT SERUNI SWEET</h4>
      <p>Menyediakan layanan dengan berbagai jenis tingkatan yang dapat disesuaikan dengan keperluan dalam meningkatkan skill menjahit.</p></br>
      <a href="login.php">
