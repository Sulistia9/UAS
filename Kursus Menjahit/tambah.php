...
<body>
  <form action="" method="post" enctype="multipart/form-data">
    <h1>Tambah Data Peserta Kursus Menjahit Seruni Sweet</h1>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      <label for="no_kmr" class="form-label">Pekerjaan</label>
      <input type="text" name="pekerjaan" class="form-control" id="pekerjaan" placeholder="contoh : Mahasiswa" required>
    </div>
    <div class="col-md-6">
      <label for="jenis" class="form-label">Jenis</label>
      <select id="jenis" name="jenis" class="form-select" required autocomplete="off">
        <option>---</option>
        <option>Tingkatan Dasar</option>
        <option>Tingkatan Terampil</option>
        <option>Tigkatan Mahir</option>
      </select>
    </div>
    <div class="col-6">
