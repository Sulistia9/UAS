...
$mhs = query("SELECT * FROM data_kursus_menjahit WHERE id = $id")[0];
...
<body>
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
      ...
      <input type="text" name="pekerjaan" class="form-control" id="pekerjaan" placeholder="contoh : Mahasiswa" required autocomplete="off" value="<?= $mhs["pekerjaan"] ?>">
    </div>
    <div class="col-md-6">
